...
public class ByteArrayUtils {
    public static void insertBytesInArray(byte[] bytesOriginal, byte[] bytesInserir, int inicio) {

        for (int i = 0; i < bytesInserir.length; i++) {

            bytesOriginal[inicio] = bytesInserir[i];
            //SEFODEU
            inicio++;
        }
    ...
    public static void insertBytesInArray(byte[] bytesOriginal, byte bytesInserir, int inicio) {
        ...
        bytesOriginal[inicio] = bytesInserir;


    }

    public static byte[] intTo4Bytes(int a) {
    ...
    public static String[] concatStringArray(String[] p, String[] q) {

        ArrayList<String> aux = new ArrayList<>();
        aux.addAll(Arrays.asList(p));
        aux.addAll(Arrays.asList(q));


        return aux.toArray(new String[p.length + q.length]);
    }
